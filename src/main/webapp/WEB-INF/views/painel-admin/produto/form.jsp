...
<body>
	...
	<div class="container">
		<h1>Novo produto</h1>
		<form action="IncluirProduto" method="post" id="form" name="form"
		onsubmit="return validarFormulario();">
		<div class="row">
			<label for="categoria">Categoria:</label> <select id="categoria"
				name="categoria"
				onblur="validaCampos(this,document.getElementById('aviso_categoria'))">
				<option></option>
		...
		<div class="row">
			<label for="nome">Nome:</label> <input type="text" id="nome"
				name="nome"
				onblur="validaCampos(this,document.getElementById('aviso_nome'))" />
			<br /> <span id="aviso_nome"></span>
		</div>
		<div class="row">
			<label for="descricao">Descrição:</label>
			<textarea rows="5" cols="30" id="descricao" name="descricao"
				onblur="validaCampos(this,document.getElementById('aviso_descricao'))"></textarea>
			<br /> <span id="aviso_descricao"></span>
		</div>
		<div class="row">
			<label for="preco">Preço:</label> <input type="text" id="preco"
				name="preco"
				onblur="validaCampos(this,document.getElementById('aviso_preco'))" />
